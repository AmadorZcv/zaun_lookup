defmodule ZaunLookupWeb.MatchControllerTest do
  ...
  @create_attrs %{game_creation: 42, game_duration: 42, game_id: 42, game_mode: "some game_mode", game_type: "some game_type", game_version: "some game_version", map_id: 42, platform_id: "some platform_id", queue_id: 42, season_id: 42, winning_team: "some winning_team"}
